...
public class toolsDocuments {
    ...
    private void handleButtonPlus() throws IOException {
        ...
        result.ifPresent(documentData -> {
            System.out.println("Author: " + documentData.getAuthor());
            System.out.println("Title: " + documentData.getTitle());
            System.out.println("Type: " + documentData.getType());
            System.out.println("YearPublished: " + documentData.getYear());
            System.out.println("Quantity: " + documentData.getQuantity());

            DocumentUtil documentutil = new DocumentUtil();
            int rowsAdded = documentutil.insert(documentData);
